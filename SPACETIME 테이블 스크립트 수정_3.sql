...
CREATE TABLE MEMBER_GRADE(
    GR_CODE CHAR(3) CONSTRAINT MEM_GRADE_PK PRIMARY KEY,
...
CREATE TABLE REPORT (
    ...
    REPORT_STATUS CHAR(1) DEFAULT 'N' CONSTRAINT REPORT_STATUS_CK CHECK (REPORT_STATUS IN ('Y', 'N')) NOT NULL,
...
COMMENT ON COLUMN SPACE.LONGTITUDE IS '경도';
...
INSERT INTO STYPE (STYPE_NO, STYPE_NAME) VALUES (SEQ_STNO.NEXTVAL, '독립오피스');
