package com.kh.spacetime.bootpay.controller;
...
public class BootpayController {
    ...
    static Bootpay bootpay = new Bootpay("638d424dd01c7e001e7bd641", "Sm+kU05f6KJuTeZcL65ZZutUQTGedEciqPKbLuIJ06Y=");
    ...
    // 결제 서버 승인 
//    public static int payServerAccess() {
//    	
//    	try {
...
//        payload.feedbackUrl = "https://84aa-211-209-221-197.jp.ngrok.io/Blueice/requestNext.do";
...
//    
     ...
     * @param billingkey
     */
//    public static void destroyBillingKey(String billingkey) {
//        try {
