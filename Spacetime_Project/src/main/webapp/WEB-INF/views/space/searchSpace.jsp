				...
				<div id="spaceList">
					...
					<form action="" method="get" id="mapFilter">
						...
						<div id="mapFilter_option_category">
							...
							<div id="mapFilter_category_list">
								<input type="checkbox" value="partyRoom">파티룸 <input
									...
									value="hall">공연장 <input type="checkbox" value="studio">연습실
						...
						<div id="mapFilter_option_price">
							...
							<div>
								<input type="range" min="1000" max="1000000" value="100"
									id="mapFilter_priceRange">
							</div>
						</div>
						<div>
