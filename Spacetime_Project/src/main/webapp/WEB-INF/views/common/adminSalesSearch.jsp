                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item no-page-prev"><a class="page-link" href="slist.ad?cpage=">&lt;</a></li>
                                    </c:otherwise>
                                </c:choose>
    ...
    <script>
        $(function() {
            $(".salesList>tbody").on("click", ".salesTr", function() {
                location.href = "sdetail.ad?sno=" + $(this).children(".sno").eq(0).val() + "&month=" + $('.detailMonth').val();
            });
        });
    </script>
